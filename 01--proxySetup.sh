...
ssh $ProxyIP bash yum -y localinstall http://$ForemanHOSTNAME/pub/katello-ca-consumer-latest.noarch.rpm
ssh $ProxyIP bash subscription-manager register --org "myorg"
